...
# windows 安装 pip install pycryptodome
# API说明
...
if __name__ == '__main__':
    dingCrypto = DingCallbackCrypto3("bvDbRzwH6mCxRobHTSLhazMD9d8YOBWvm2OzGQQOV2tHINjBCAfXLhQ", "pLCGgxa5uIO9QdfR0aPNOWSMd9vf8GrMvktKmXYXKGz", "dingxy4djebtkidkoep6")
